package anda.travel.driver.widget.floatview;
...
public class FloatingView extends RelativeLayout {
    ...
    public FloatingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        inflate(context, R.layout.hxyc_layout_float_feedback, this);
        ...
        mDp167 = (int) DisplayUtil.dp2px(mContext, 167);
        mDp48 = (int) DisplayUtil.dp2px(mContext, 48);
//        slop = ViewConfigurationCompat.getScaledPagingTouchSlop(ViewConfiguration.get(context));
    ...
    private void initFloatBallParams(Context context) {
        ...
        //mFloatBallParams.type = WindowManager.LayoutParams.TYPE_APPLICATION;
        ...
        mFloatBallParams.gravity = Gravity.RIGHT | Gravity.CENTER;
