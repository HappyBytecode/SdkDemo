...
public final class KeyBoardEventBus {
     ...
     * 单例
     */
    private static KeyBoardEventBus instance;

    /**
     * 用于缓存监听回调信息
     */
    private final Map<Object, GlobalLayoutListenerImp> callbackCache = new HashMap<>();
     ...
     * @param object   监听的类
     */
    private void register(Activity activity, Object object) {
     ...
     * @param object   监听的类
     */
    private void unregister(Activity activity, Object object) {
