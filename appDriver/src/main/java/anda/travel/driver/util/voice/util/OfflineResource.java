package anda.travel.driver.util.voice.util;
...
public class OfflineResource {
    ...
    private static final HashMap<String, Boolean> mapInitied = new HashMap<String, Boolean>();
