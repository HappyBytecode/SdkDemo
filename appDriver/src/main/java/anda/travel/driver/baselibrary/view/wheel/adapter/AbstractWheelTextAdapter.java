 ...
 */
package anda.travel.driver.baselibrary.view.wheel.adapter;
...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
     ...
     * Default text color
     */
    public static final int DEFAULT_TEXT_COLOR = 0xffcccccc;
    ...
    // Text settings
     private int blueColor = 0xFF47C3FD; // 蓝色
    //	private int redColor = 0xFFFF4E6D; // 红色
//    private int greenColor = 0xFF10CB7E; // 绿色
...
//        blueColor = context.getResources().getColor(R.color.black);
    ...
    protected void configureTextView(TextView view, int position) {
        if (changeClr && position == currentItem) {
            // 绿色
            view.setTextColor(blueColor);
        } else {
            // 默认颜色
            view.setTextColor(textColor);
        }
