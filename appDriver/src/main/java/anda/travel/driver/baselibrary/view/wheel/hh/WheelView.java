...
package anda.travel.driver.baselibrary.view.wheel.hh;
...
import anda.travel.driver.baselibrary.view.wheel.adapter.AbstractWheelTextAdapter;
import anda.travel.driver.baselibrary.view.wheel.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void onChange() {
        if (viewAdapter != null && viewAdapter instanceof AbstractWheelTextAdapter) {
            ((AbstractWheelTextAdapter) viewAdapter).setCurrentIndex(currentItem);
        }
    }
...
//	private int wheelBackground = R.drawable.wheel_bg;
    ...
    private int wheelBackground = Color.TRANSPARENT;
    //	 private int wheelForeground = R.color.white_trans;
    // Shadows drawables
