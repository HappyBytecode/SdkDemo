...
public class SuperViewHolder extends RecyclerView.ViewHolder implements ChainSetter<SuperViewHolder> {
    ...
    public static SuperViewHolder get(View itemView) {
        SuperViewHolder holder = new SuperViewHolder(itemView);
        return holder;
    }
    ...
    @Override
    public SuperViewHolder setText(int viewId, int textResId) {
        TextView textView = getView(viewId);
